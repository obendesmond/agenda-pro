...
// delete all agenda
export const DELETE_ALL_AGENDA_REQUEST = "DELETE_ALL_AGENDA_REQUEST";
export const DELETE_ALL_AGENDA_SUCCESS = "DELETE_ALL_AGENDA_SUCCESS";
export const DELETE_ALL_AGENDA_FAIL = "DELETE_ALL_AGENDA_FAIL";
